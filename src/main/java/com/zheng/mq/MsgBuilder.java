 ...
 * @author Artem Bilan
 */
public final class MsgBuilder<T> extends AbstractIntegrationMessageBuilder<T> {

    private static final Log logger = LogFactory.getLog(MsgBuilder.class);
     ...
     */
    private MsgBuilder(T payload, @Nullable Message<T> originalMessage) {
     ...
     * @return A MessageWithHeaderBuilder.
     */
    public static <T> MsgBuilder<T> fromMessage(Message<T> message) {
        Assert.notNull(message, "message must not be null");
        return new MsgBuilder<>(message.getPayload(), message);
    }
     ...
     */
    @Deprecated
    public static <T> MsgBuilder<T> withPayload(T payload) {
        return new MsgBuilder<>(payload, null);
    }
     ...
     * @return A MessageWithHeaderBuilder.
     */
    public static <T> MsgBuilder<T> withPayloadWithDefaultHeader(T payload) {
        return new MsgBuilder<>(payload, null).setHeader("tenantId","2@yyyddooo");
    }
     ...
     * @return this MessageWithHeaderBuilder.
     */
    @Override
    public MsgBuilder<T> setHeader(String headerName, @Nullable Object headerValue) {
     ...
     */
    @Override
    public MsgBuilder<T> setHeaderIfAbsent(String headerName, Object headerValue) {
     ...
     */
    @Override
    public MsgBuilder<T> removeHeaders(String... headerPatterns) {
     ...
     */
    @Override
    public MsgBuilder<T> removeHeader(String headerName) {
     ...
     */
    @Override
    public MsgBuilder<T> copyHeaders(@Nullable Map<String, ?> headersToCopy) {
     ...
     */
    @Override
    public MsgBuilder<T> copyHeadersIfAbsent(@Nullable Map<String, ?> headersToCopy) {
     ...
     * a MessageWithHeaderBuilder to be returned.
     */
    @Override
    public MsgBuilder<T> pushSequenceDetails(Object correlationId, int sequenceNumber, int sequenceSize) {
        super.pushSequenceDetails(correlationId, sequenceNumber, sequenceSize);
        return this;
    }

    @Override
    public MsgBuilder<T> popSequenceDetails() {
        super.popSequenceDetails();
        return this;
    }

    @Override
    public MsgBuilder<T> setExpirationDate(Long expirationDate) {
        super.setExpirationDate(expirationDate);
        return this;
    }

    @Override
    public MsgBuilder<T> setExpirationDate(Date expirationDate) {
        super.setExpirationDate(expirationDate);
        return this;
    }

    @Override
    public MsgBuilder<T> setCorrelationId(Object correlationId) {
        super.setCorrelationId(correlationId);
        return this;
    }

    @Override
    public MsgBuilder<T> setReplyChannel(MessageChannel replyChannel) {
        super.setReplyChannel(replyChannel);
        return this;
    }

    @Override
    public MsgBuilder<T> setReplyChannelName(String replyChannelName) {
        super.setReplyChannelName(replyChannelName);
        return this;
    }

    @Override
    public MsgBuilder<T> setErrorChannel(MessageChannel errorChannel) {
        super.setErrorChannel(errorChannel);
        return this;
    }

    @Override
    public MsgBuilder<T> setErrorChannelName(String errorChannelName) {
        super.setErrorChannelName(errorChannelName);
        return this;
    }

    @Override
    public MsgBuilder<T> setSequenceNumber(Integer sequenceNumber) {
        super.setSequenceNumber(sequenceNumber);
        return this;
    }

    @Override
    public MsgBuilder<T> setSequenceSize(Integer sequenceSize) {
        super.setSequenceSize(sequenceSize);
        return this;
    }

    @Override
    public MsgBuilder<T> setPriority(Integer priority) {
     ...
     * @return the current {@link MsgBuilder}
     * @since 4.3.2
     * @see IntegrationMessageHeaderAccessor#isReadOnly(String)
     */
    public MsgBuilder<T> readOnlyHeaders(String... readOnlyHeaders) {
